<template>
  <!-- Hero Section -->
  <div class="sm:static md:relative bg-gray-50 overflow-hidden">
    ...
    <div
      class="sm:static md:relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32"
    >
      <main
                  ...
                  <div class="bg-white px-6 py-10">
                    <div>
                      ...
                      <div class="mt-4 flex items-center justify-center">
                        ...
                        <span
                          class="text-xl leading-7 font-medium text-gray-500"
                        >
                          /month
                        </span>
                      </div>
